...
//
//@interface UITextField (XHInputType)<UITextFieldDelegate>
//
//@end


@interface XHInputTextField ()<UITextFieldDelegate>
{
...
@implementation XHInputTextField

- (instancetype)initWithFrame:(CGRect)frame
{
    self = [super initWithFrame:frame];
    if (self) {
        [self monitorTextFiledValue];
    }
    return self;
}
...
{
    self.delegate = self;
    [self addTarget:self action:@selector(p_textFieldDidChangeValue:) forControlEvents:UIControlEventEditingChanged];
}
